...
threeThemePath = sys.argv[1]
destDirPath = sys.argv[2]

import os
threeThemeFileName,threeThemeFileExt = os.path.splitext(os.path.basename(threeThemePath));

file = destDirPath + "/" + threeThemeFileName + ".dvtcolortheme"
